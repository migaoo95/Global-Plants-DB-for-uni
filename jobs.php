...
$sql = "SELECT job.job_id,job.job_name,job.job_descryption,workLocation.location_name FROM job 
                ...
                <div class="form">
                    <form action="jobs.php" method="post" name="name">
                        ...
                        <select name="emp" id="ss">
                            ...
                            <?php
                            $sql2 = "SELECT firstName,employee_id FROM employee INNER JOIN jobAllocation ON employee.employee_id = jobAllocation.all_emp_id WHERE jobAllocation.all_job_id IS NULL";
                    ...
                    <?php
                    $submit = "INSERT INTO jobTransfer(request_date,descryption,tr_emp_id,tr_job_id) VALUES ('2000-10-10','$note',$idd,$jobid)";
                    ...
                    if (isset($jobs)) {
                        ...
                        echo "<div style='border:solid; margin-bottom:10px;background-color:#2faabd;'>" . "Thank you " . "<span style='font-weight:bold;'>" . $emp . "</span>" . " your application for position " . "<span style='font-weight:bold;'>" . $jobs . "</span>"  . " it have been sent to your employer <br>" . "</div>";
                    }
                    ?>
